<div class="grid grid-cols-4 mt-12 gap-4">
                        ...
                        <td class="pl-2">
                            <button wire:click="delete({{ $item->id }})">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                    ...
                                    1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772
                                    5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5
    ...
    <div>
        <div class="bg-white rounded-lg shadow p-5 col-span-1">
            @guest
                <p>
                    Please <a href="{{ route('register') }}" class="underline">register</a>
                    or <a href="{{ route('login') }}" class="underline"> login </a>
                    to continue.
                </p>
            @endguest
